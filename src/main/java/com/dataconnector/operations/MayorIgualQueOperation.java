...
/**
 *Implementacion que representa el operador MAYOR QUE(>=) del lenguaje SQL
 * @version $Revision: 1.1.1  (UTF-8)
 * @since build 26/02/2016  
 * @author proveedor_hhurtado  email: proveedor_hhurtad@ath.com.co
 */
public class MayorIgualQueOperation  extends AbstractOperPredicate  implements JoinPredicate {

    public MayorIgualQueOperation() {
        super(OperationEnum.MAYOR_IGUAL_QUE);
    }
