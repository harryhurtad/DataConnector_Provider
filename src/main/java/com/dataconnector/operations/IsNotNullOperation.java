...
/**
 *Implementacion que representa el operador IS NOT NULL del lenguaje SQL
 * @version $Revision: 1.1.1  (UTF-8)
 * @since build 26/02/2016  
 * @author proveedor_hhurtado  email: proveedor_hhurtad@ath.com.co
 */
public class IsNotNullOperation extends AbstractOperPredicate {

    public IsNotNullOperation() {
        super(OperationEnum.IS_NOT_NULL);
    }
