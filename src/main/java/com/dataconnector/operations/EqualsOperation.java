...
/**
 * Implementacion que representa el operador EQUALS del lenguaje SQL
 *
 * @version $Revision: 1.1.1 (UTF-8)
 * @since build 26/02/2016
 * @author proveedor_hhurtado email: proveedor_hhurtad@ath.com.co
 */
public final class EqualsOperation extends AbstractOperPredicate implements JoinPredicate {

    public EqualsOperation() {
        super(OperationEnum.EQUALS);
